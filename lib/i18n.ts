import { CREATURE_COUNT, COUNTRY_COUNT } from "./site-stats";
...
const ko: Dictionary = {
  ...
  "index.desc": `19개 대륙, ${COUNTRY_COUNT}개국의 전설 속 존재들을 탐험하세요`,
  "index.viewAll": "전체 보기 →",
  "index.breadcrumb": "크리처 도감",
  "meta.siteName": "세계 요괴 도감",
  "meta.siteDesc": `${COUNTRY_COUNT}개국 ${CREATURE_COUNT.toLocaleString("en-US")}종 전설 속 존재들의 인터랙티브 월드맵`,
...
const en: Dictionary = {
  ...
  "index.desc": `Explore legendary creatures from 19 regions and ${COUNTRY_COUNT} countries`,
  "index.viewAll": "View all →",
  "index.breadcrumb": "Creature Index",
  "meta.siteName": "Global Folklore Bestiary",
  "meta.siteDesc": `Interactive world map of ${CREATURE_COUNT.toLocaleString("en-US")} legendary creatures from ${COUNTRY_COUNT} countries`,
...
const zh: Dictionary = {
  ...
  "index.desc": `探索19个大洲、${COUNTRY_COUNT}个国家的传说生物`,
  "index.viewAll": "查看全部 →",
  "index.breadcrumb": "生物图鉴",
  "meta.siteName": "世界妖怪图鉴",
  "meta.siteDesc": `${COUNTRY_COUNT}个国家${CREATURE_COUNT.toLocaleString("en-US")}种传说生物的互动世界地图`,
...
const ja: Dictionary = {
  ...
  "index.desc": `19大陸、${COUNTRY_COUNT}カ国の伝説の存在を探検しよう`,
  "index.viewAll": "すべて見る →",
  "index.breadcrumb": "クリーチャー図鑑",
  "meta.siteName": "世界妖怪図鑑",
  "meta.siteDesc": `${COUNTRY_COUNT}カ国${CREATURE_COUNT.toLocaleString("en-US")}種の伝説の存在のインタラクティブワールドマップ`,
