...
const ko: Dictionary = {
  ...
  "index.desc": "19개 대륙, 145개국의 전설 속 존재들을 탐험하세요",
  "index.viewAll": "전체 보기 →",
  "index.breadcrumb": "크리처 도감",
  "meta.siteName": "세계 요괴 도감",
  "meta.siteDesc": "145개국 1,500종 전설 속 존재들의 인터랙티브 월드맵",
...
const en: Dictionary = {
  ...
  "index.desc": "Explore legendary creatures from 19 regions and 145 countries",
  "index.viewAll": "View all →",
  "index.breadcrumb": "Creature Index",
  "meta.siteName": "Global Folklore Bestiary",
  "meta.siteDesc": "Interactive world map of 1,500 legendary creatures from 145 countries",
...
const zh: Dictionary = {
  ...
  "index.desc": "探索19个大洲、145个国家的传说生物",
  "index.viewAll": "查看全部 →",
  "index.breadcrumb": "生物图鉴",
  "meta.siteName": "世界妖怪图鉴",
  "meta.siteDesc": "145个国家1,500种传说生物的互动世界地图",
...
const ja: Dictionary = {
  ...
  "index.desc": "19大陸、145カ国の伝説の存在を探検しよう",
  "index.viewAll": "すべて見る →",
  "index.breadcrumb": "クリーチャー図鑑",
  "meta.siteName": "世界妖怪図鑑",
  "meta.siteDesc": "145カ国1,500種の伝説の存在のインタラクティブワールドマップ",
