...
const ko: Dictionary = {
  ...
  "meta.siteDesc": "151개국 1,261종 전설 속 존재들의 인터랙티브 월드맵",
...
const en: Dictionary = {
  ...
  "meta.siteDesc": "Interactive world map of 1,261 legendary creatures from 151 countries",
...
const zh: Dictionary = {
  ...
  "meta.siteDesc": "151个国家1,261种传说生物的互动世界地图",
...
const ja: Dictionary = {
  ...
  "meta.siteDesc": "151カ国1,261種の伝説の存在のインタラクティブワールドマップ",
